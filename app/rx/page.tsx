      ...
      <section className="section sec-band2">
        <div className="wrap">
          ...
          <h2 className="h2" style={{ maxWidth: "680px", marginBottom: "44px" }}>
            Signal-to-Opportunity delivers targeted brand advantage.
          </h2>
          <SignalStrip
            items={[
              {
      ...
      <section className="section sec-white" id="model">
        <div className="wrap">
          ...
          <p className="body-text" style={{ maxWidth: "640px", marginTop: "16px" }}>
            ...
            strategy, activation, and outcomes that follow.
          </p>
          <div className="model">
            <ModelCard number="01" title="Medical Signal" tc="#5B86E8" body="Clinical evidence, expert insight, and outcomes translated into a clear foundation for brand strategy." />
            <ModelCard number="02" title="Brand Strategy" tc="#2366E8" body="Market, competitive, and target signals shaped into positioning and go-to-market strategy." />
            <ModelCard number="03" title="Creative Intelligence" tc="#8FA9D9" body="Brand strategy transformed into a full brand plan with content systems and designed experiences." />
            <ModelCard number="04" title="Market Activation" tc="#E85D06" body="Agile, market-ready communications built for execution, consistency, and brand outcomes." />
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          ...
          <WhyBlock
            ...
            reasons={[
              ...
              { title: "Faster evidence-to-engagement", body: "Evidence and framing happen before execution." },
              { title: "Modern operating model, group backing", body: "An AI-enabled operating model, backed by BeCon Group." },
              { title: "Built around the outcomes that deliver the opportunity", body: "Narrative clarity, engagement readiness, content usability.", span2: true },
            ]}
          />
        </div>
      </section>
