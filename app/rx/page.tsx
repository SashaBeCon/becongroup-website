    ...
    <main>
      ...
      <Section bg="paper" size="sm">
        <SignalStrip
          ...
          middle={{
            label: "The model",
            title: "Signal-to-Opportunity delivers targeted brand advantage.",
          }}
          right={{
      ...
      <Section bg="white" id="model">
        <SectionHeader
          ...
          subtitle="Medical signal sets the foundation. Market, competitive, and audience signals shape the strategy, activation, and outcomes that follow."
          size="lg"
        />
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <ModelCard
            number="01"
            title="Medical Signal"
            body="Clinical evidence, expert insight, and outcomes translated into a clear foundation for brand strategy."
            tone="blue-soft"
          />
          <ModelCard
            number="02"
            title="Brand Strategy"
            body="Market, competitive, and target signals shaped into positioning and go-to-market strategy."
            tone="white"
          />
          <ModelCard
            number="03"
            title="Creative Intelligence"
            body="Brand strategy transformed into a full brand plan with content systems and designed experiences."
            tone="ink"
          />
          <ModelCard
            number="04"
            title="Market Activation"
            body="Agile, market-ready communications built for execution, consistency, and brand outcomes."
            tone="paper"
          />
        </div>
      </Section>
          ...
          <WhyBlock
            ...
            reasons={[
              ...
              },
              {
                ...
                body: "Evidence and framing happen before execution.",
              },
              {
                title: "Modern operating model, group backing",
                body: "An AI-enabled operating model, backed by BeCon Group.",
              },
              {
                title: "Built around the outcomes that deliver the opportunity",
                body: "Narrative clarity, engagement readiness, content usability.",
              },
            ]}
          />
        </div>
